...
#
#     PHX_SERVER=true bin/luca_webapp start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :luca_webapp, LucaWebappWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :luca_webapp, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :luca_webapp, LucaWebapp.Mailer,
